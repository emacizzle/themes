...
<div id="wrapper" class="hfeed">
	...
	<div id="header">
                <a href="<?php echo get_option('home') ?>/" title="<?php bloginfo('name') ?>" rel="home"><img src="http://hydra.si/files/2009/11/logo_and_tag.png" alt="Hydrasi: Try To Save The World" height="100px"></a>
...
-->	</div><!--  #header -->
	...
	<div id="access">
      ...
      <div id="menu"><ul>
          <li >Water.</li>
          <li class="page_item">Climate.</li>
          <li class="page_item">Data.</li>
      </ul></div>
	</div><!-- #access -->