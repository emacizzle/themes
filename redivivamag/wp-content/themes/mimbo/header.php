...
<?php // ------------------ Top Pages Here ----------------------
      wp_list_pages('title_li=&include=79,8,1319,1419'); ?>
</ul>
...
<h1><a href="<?php echo get_option('home'); ?>/" title="<?php _e('Return Home','Mimbo'); ?>">
    <img src="http://www.redivivamag.com/images/logo.jpg" title="Rediviva Magazine" alt="Rediviva Magazine" />
</a></h1>
...
<?php // --------------- Bottom Pages Here ---------------------
      // Add list of pages included above, all other pages will be here.
      wp_list_pages('title_li=&exclude=79,8,1319,1419'); ?>
</ul>